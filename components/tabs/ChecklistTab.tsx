          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <button
                className="choice-btn"
                style={{ width: 'auto' }}
                data-active={qd.soffit.includeRemoval ? 'true' : 'false'}
                onClick={() => updateDraft((d) => ({ ...d, quoteDetails: { ...d.quoteDetails, soffit: { ...d.quoteDetails.soffit, includeRemoval: !d.quoteDetails.soffit.includeRemoval } } }))}
              >
                Include Removal
              </button>
            </div>
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <button
                className="choice-btn"
                style={{ width: 'auto' }}
                data-active={qd.fascia.includeRemoval ? 'true' : 'false'}
                onClick={() => updateDraft((d) => ({ ...d, quoteDetails: { ...d.quoteDetails, fascia: { ...d.quoteDetails.fascia, includeRemoval: !d.quoteDetails.fascia.includeRemoval } } }))}
              >
                Include Removal
              </button>
            </div>
          ...
          <div className="mb-2">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <button
                className="choice-btn"
                style={{ width: 'auto' }}
                data-active={qd.gutters.includeGuards ? 'true' : 'false'}
                onClick={() => updateDraft((d) => ({ ...d, quoteDetails: { ...d.quoteDetails, gutters: { ...d.quoteDetails.gutters, includeGuards: !d.quoteDetails.gutters.includeGuards } } }))}
              >
                Gutter Guards
              </button>
              <button
                className="choice-btn"
                style={{ width: 'auto' }}
                data-active={qd.gutters.includeRemoval ? 'true' : 'false'}
                onClick={() => updateDraft((d) => ({ ...d, quoteDetails: { ...d.quoteDetails, gutters: { ...d.quoteDetails.gutters, includeRemoval: !d.quoteDetails.gutters.includeRemoval } } }))}
              >
                Include Removal
              </button>
            </div>
